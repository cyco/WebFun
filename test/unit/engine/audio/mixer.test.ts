...
describe("WebFun.Engine.Audio.Mixer", () => {
	let subject: Mixer<any>;
	let providerMock: () => void;
	let effectsChannel: Channel<any>;
	let musicChannel: Channel<any>;

	beforeEach(() => {
		providerMock = () => void 0;
		effectsChannel = ({} as any) as Channel<any>;
		musicChannel = ({} as any) as Channel<any>;
