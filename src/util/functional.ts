...
export const not = (predicate: Predicate) => (...args: any[]): boolean => !predicate(...args);
export const and = (...predicates: Predicate[]) => (...args: any[]): boolean =>
	predicates.every(t => t(...args));
export const or = (...predicates: Predicate[]) => (...args: any[]): boolean =>
