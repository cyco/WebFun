...
class WorldItemType {
	...
	public get rawValue() {
		switch (this) {
			...
			case WorldItemType.BlockSouth:
				return 304;
			case WorldItemType.KeptFree:
				return 305;
			case WorldItemType.Puzzle:
				return 306;
			default:
				return null;
		}
	...
	public static fromNumber(number: number): WorldItemType {
		...
		switch (number) {
			...
			case 1:
				return WorldItemType.Empty;
			case 101:
				return WorldItemType.TravelStart;
			case 102:
				return WorldItemType.TravelEnd;
			case 104:
				return WorldItemType.Island;
			case 201:
				return WorldItemType.Spaceport;
			case 300:
				return WorldItemType.Candidate;
			case 301:
			...
			case 305:
				return WorldItemType.KeptFree;
			case 306:
				return WorldItemType.Puzzle;
		}
	}
