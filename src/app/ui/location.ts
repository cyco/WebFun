...
class Location extends Component {
	...
	_updateClassList() {
		...
		const set = (on: number, c: string) =>
			(on ? classList.add.bind(classList) : classList.remove.bind(classList))(c);
