var Module = (function () {
	...
	return function (Module) {
		...
		var wasmMemory;
		var wasmTable = new WebAssembly.Table({ initial: 50, maximum: 50, element: "anyfunc" });
		var ABORT = false;
		var EXITSTATUS = 0;
		...
		var DYNAMIC_BASE = 5280688,
			DYNAMICTOP_PTR = 37600;
		...
		var _render = (Module["_render"] = function () {
			return (_render = Module["_render"] = Module["asm"]["q"]).apply(null, arguments);
		});
		...
		Module["onRuntimeInitialized"] = function () {
			Module["getVersion"] = cwrap("get_version", "string", [], []);
			Module["render"] = function (data, filename) {
